  ...
  return (function (e) {
    ...
    function (e, t) {
      ...
      function u() {
        p &&
          s &&
          ((p = !1), s.length ? (d = s.concat(d)) : (c = -1), d.length && y());
      }
      function y() {
        if (!p) {
          var e = l(u);
        ...
        return new Promise(function (t, p) {
          ...
          if (
            (y.open(
              ...
              r(f, e.params, e.paramsSerializer),
              !0
            ),
            (y.timeout = e.timeout),
            ...
            var v = a(54),
              b =
                (e.withCredentials || s(f)) && e.xsrfCookieName
    ...
    function (e, t) {
      e.exports =
        '<svg xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 16 32"><path d="M15.552 15.168q0.448 0.32 0.448 0.832 0 0.448-0.448 0.768l-13.696 8.512q-0.768 0.512-1.312 0.192t-0.544-1.28v-16.448q0-0.96 0.544-1.28t1.312 0.192z"></path></svg>';
    },
    function (e, t) {
      e.exports =
        '<svg xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 17 32"><path d="M14.080 4.8q2.88 0 2.88 2.048v18.24q0 2.112-2.88 2.112t-2.88-2.112v-18.24q0-2.048 2.88-2.048zM2.88 4.8q2.88 0 2.88 2.048v18.24q0 2.112-2.88 2.112t-2.88-2.112v-18.24q0-2.048 2.88-2.048z"></path></svg>';
    },
    function (e, t) {
      e.exports =
        '<svg xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 21 32"><path d="M13.728 6.272v19.456q0 0.448-0.352 0.8t-0.8 0.32-0.8-0.32l-5.952-5.952h-4.672q-0.48 0-0.8-0.352t-0.352-0.8v-6.848q0-0.48 0.352-0.8t0.8-0.352h4.672l5.952-5.952q0.32-0.32 0.8-0.32t0.8 0.32 0.352 0.8zM20.576 16q0 1.344-0.768 2.528t-2.016 1.664q-0.16 0.096-0.448 0.096-0.448 0-0.8-0.32t-0.32-0.832q0-0.384 0.192-0.64t0.544-0.448 0.608-0.384 0.512-0.64 0.192-1.024-0.192-1.024-0.512-0.64-0.608-0.384-0.544-0.448-0.192-0.64q0-0.48 0.32-0.832t0.8-0.32q0.288 0 0.448 0.096 1.248 0.48 2.016 1.664t0.768 2.528zM25.152 16q0 2.72-1.536 5.056t-4 3.36q-0.256 0.096-0.448 0.096-0.48 0-0.832-0.352t-0.32-0.8q0-0.704 0.672-1.056 1.024-0.512 1.376-0.8 1.312-0.96 2.048-2.4t0.736-3.104-0.736-3.104-2.048-2.4q-0.352-0.288-1.376-0.8-0.672-0.352-0.672-1.056 0-0.448 0.32-0.8t0.8-0.352q0.224 0 0.48 0.096 2.496 1.056 4 3.36t1.536 5.056z"></path></svg>';
    },
    function (e, t) {
      e.exports =
      ...
      (s.prototype.request = function (e) {
        ...
        n.forEach(["post", "put", "patch"], function (e) {
          s.prototype[e] = function (t, a, o) {
            return this.request(
              n.merge(o || {}, { method: e, url: t, data: a })
            );
          };
        }),
        (e.exports = s);
    ...
    function (e, t, a) {
          ...
          (a = [
            {
              ...
              value: function () {
                (this.container.innerHTML = $()({
                  ...
                  (this.volumeButton =
                    this.container.querySelector(".dplayer-volume")),
                  (this.volumeButtonIcon = this.container.querySelector(
                    ".dplayer-volume-icon"
                  )),
                  (this.volumeIcon = this.container.querySelector(
                    ".dplayer-volume-icon .dplayer-icon-content"
                  )),
                  (this.playedBar =
                    this.container.querySelector(".dplayer-played")),
                  (this.loadedBar =
                    this.container.querySelector(".dplayer-loaded")),
                  (this.playedBarWrap =
                    this.container.querySelector(".dplayer-bar-wrap")),
                  (this.playedBarTime =
                    this.container.querySelector(".dplayer-bar-time")),
                  (this.danmaku =
                    this.container.querySelector(".dplayer-danmaku")),
                  ...
                  (this.playButton =
                    this.container.querySelector(".dplayer-play-icon")),
                  ...
                  (this.danmakuOpacityBarWrapWrap =
                    this.container.querySelector(".dplayer-danmaku-bar-wrap")),
                  ...
                  (this.commentSettingFill = this.container.querySelector(
                    ".dplayer-comment-setting-icon path"
                  )),
                  (this.commentSendButton =
                    this.container.querySelector(".dplayer-send-icon")),
                  (this.commentSendFill = this.container.querySelector(
                    ".dplayer-send-icon path"
                  )),
                  (this.commentColorSettingBox = this.container.querySelector(
                    ".dplayer-comment-setting-color"
                  )),
                  (this.browserFullButton =
                    this.container.querySelector(".dplayer-full-icon")),
                  (this.webFullButton = this.container.querySelector(
                    ".dplayer-full-in-icon"
                  )),
                  (this.menu = this.container.querySelector(".dplayer-menu")),
                  (this.menuItem =
                    this.container.querySelectorAll(".dplayer-menu-item")),
                  ...
                  (this.airplayButton = this.container.querySelector(
                  ...
                  (this.subtitleButtonInner = this.container.querySelector(
                    ".dplayer-subtitle-icon .dplayer-icon-content"
                  )),
                  (this.subtitle =
                    this.container.querySelector(".dplayer-subtitle")),
                  ...
                  (this.barWrap =
                    this.container.querySelector(".dplayer-bar-wrap")),
                  (this.notice =
                    this.container.querySelector(".dplayer-notice")),
                  ...
                  (this.infoVersion = this.container.querySelector(
                    ".dplayer-info-panel-item-version .dplayer-info-panel-item-data"
                  )),
                  (this.infoFPS = this.container.querySelector(
                    ".dplayer-info-panel-item-fps .dplayer-info-panel-item-data"
                  )),
                  (this.infoType = this.container.querySelector(
                    ".dplayer-info-panel-item-type .dplayer-info-panel-item-data"
                  )),
                  ...
                  (this.infoResolution = this.container.querySelector(
                    ".dplayer-info-panel-item-resolution .dplayer-info-panel-item-data"
                  )),
                  (this.infoDuration = this.container.querySelector(
                    ".dplayer-info-panel-item-duration .dplayer-info-panel-item-data"
                  )),
                  (this.infoDanmakuId = this.container.querySelector(
                    ".dplayer-info-panel-item-danmaku-id .dplayer-info-panel-item-data"
                  )),
                  (this.infoDanmakuApi = this.container.querySelector(
                    ".dplayer-info-panel-item-danmaku-api .dplayer-info-panel-item-data"
                  )),
          ...
          (a = [
            {
              ...
              value: function () {
                ...
                e = this.options.api.maximum
                  ? ""
                      .concat(this.options.api.address, "v3/?id=")
                      .concat(this.options.api.id, "&max=")
                      .concat(this.options.api.maximum)
                  : ""
                      .concat(this.options.api.address, "v3/?id=")
                      .concat(this.options.api.id);
                  ...
                  var a = this,
                    ...
                    r = function (r) {
                      a.options.apiBackend.read({
                        ...
                        error: function (i) {
                          a.options.error(
                            i || a.options.tran("Danmaku load failed")
                          ),
                            (n[r] = []),
                            ++o === e.length && t(n);
                        },
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.dan.length && !this.paused && this.showing) {
                  for (
                    var t = this.dan[this.danIndex], a = [];
                    ...
                    l = function (e) {
                      var a = e.offsetWidth || parseInt(e.style.width),
                        n =
                          ...
                          t.container.getBoundingClientRect().right + a;
                        ...
                        var r = n / s(o),
                          d = function (o) {
                            ...
                            for (var p = 0; p < d.length; p++) {
                              var c = l(d[p]) - 10;
                              if (
                                c <= n - r * s(parseInt(d[p].style.width)) ||
                                c <= 0
                              )
                                break;
                              if (p === d.length - 1)
                    ...
                    var p = document.createDocumentFragment(),
                      c = function (o) {
                        ...
                        i.classList.add("dplayer-danmaku-item"),
                          ...
                          e[o].border
                            ? (i.innerHTML = '<span style="border:'
                                .concat(e[o].border, '">')
                                .concat(e[o].text, "</span>"))
                        ...
                        switch (e[o].type) {
                          case "right":
                            (s = d(i, e[o].type, l)) >= 0 &&
                              ...
                              (i.style.top = a * s + "px"),
                              (i.style.transform = "translateX(-".concat(
                                n,
                                "px)"
                              )));
                            break;
                          ...
                          case "bottom":
                            (s = d(i, e[o].type)) >= 0 &&
                              (i.style.bottom = a * s + "px");
                            break;
                          default:
                            console.error(
                              "Can't handled danmaku type: ".concat(e[o].type)
                            );
                        }
                        s >= 0 &&
                          (i.classList.add("dplayer-danmaku-move"),
                          p.appendChild(i));
                      },
                      u = 0;
                    u < e.length;
            ...
            },
            {
              ...
              value: function (e, t) {
                if (this.events[e] && this.events[e].length)
                  for (var a = 0; a < this.events[e].length; a++)
                    this.events[e][a](t);
              },
            },
            {
              ...
              a.player.resize(),
                a.isFullScreen("browser")
                  ...
                  : (r.setScrollPosition(a.lastScrollPosition),
                    a.player.events.trigger("fullscreen_cancel"));
            },
            o = function () {
              var e =
                document.fullscreenElement ||
          ...
          (a = [
            ...
            },
            {
              ...
              value: function () {
                ...
                switch (
                  (a || (this.lastScrollPosition = r.getScrollPosition()), e)
                ) {
                  case "browser":
      ...
      var ie = (function () {
        function e(t) {
          !(function (e, t) {
            ...
            (this.default = {
              opacity: 0.7,
              volume: t.options.hasOwnProperty("volume")
                ? t.options.volume
                : 0.7,
              unlimited:
                (t.options.danmaku && t.options.danmaku.unlimited ? 1 : 0) || 0,
              danmaku: 1,
              subtitle: 1,
            }),
            (this.data = {}),
              ...
              value: function () {
                for (var e in this.storageName) {
                  ...
                  this.data[e] = parseFloat(
                    r.storage.get(t) || this.default[e]
                  );
                }
              },
            },
        ...
        return (
          ...
          (a = [
            ...
            },
            {
              key: "toggle",
              value: function () {
                this.container.classList.contains("dplayer-subtitle-hide")
                  ? this.show()
                  : this.hide();
              },
            },
          ...
          (a = [
                ...
                this.loadingChecker = setInterval(function () {
                  e.enableloadingChecker &&
                    ...
                    n ||
                      ...
                      (e.player.container.classList.add("dplayer-loading"),
                      (n = !0)),
                    n &&
                      a > t &&
                      !e.player.video.paused &&
                      (e.player.container.classList.remove("dplayer-loading"),
                      (n = !1)),
                    (t = a));
                }, 100);
              },
            ...
            },
            {
              ...
              value: function () {
                ...
                this.types.map(function (t) {
                  return (
                    (e["enable".concat(t, "Checker")] = !1),
                    e["".concat(t, "Checker")] &&
                      clearInterval(e["".concat(t, "Checker")]),
                    t
                  );
                });
              },
        ...
        return (
          ...
          (a = [
            ...
            },
            {
              key: "move",
              value: function (e) {
                (this.container.style.backgroundPosition = "-".concat(
          ...
          (a = [
            {
              ...
              value: function () {
                ...
                this.player.template.playButton.addEventListener(
                  ...
                  this.player.template.mobilePlayButton.addEventListener(
                    "click",
                    function () {
                      e.player.toggle();
                    }
            ...
            },
            {
              ...
              value: function () {
                ...
                this.player.on("durationchange", function () {
                  if (
                    1 !== e.player.video.duration &&
                    e.player.video.duration !== 1 / 0 &&
                    e.player.options.highlight
                  ) {
                    ...
                    for (var a = 0; a < e.player.options.highlight.length; a++)
                      if (
                        e.player.options.highlight[a].text &&
                        e.player.options.highlight[a].time
                      ) {
                        var n = document.createElement("div");
                        n.classList.add("dplayer-highlight"),
                          ...
                          (n.innerHTML =
                            ...
                            e.player.options.highlight[a].text +
                            "</span>"),
                          e.player.template.playedBarWrap.insertBefore(
                            n,
                            e.player.template.playedBarTime
                          );
                      }
                  }
                });
              ...
              value: function () {
                ...
                this.player.options.video.thumbnails &&
                  ...
                  this.player.on("loadedmetadata", function () {
                    e.thumbnails.resize(
                      160,
                      (e.player.video.videoHeight / e.player.video.videoWidth) *
                        160,
                  ...
                  t = function (t) {
                    var a =
                      ((t.clientX || t.changedTouches[0].clientX) -
                        r.getBoundingClientRectViewLeft(
                    ...
                    (a = Math.max(a, 0)),
                      ...
                      (e.player.template.ptime.innerHTML = r.secondToTime(
                        a * e.player.video.duration
                      ));
                  },
                  a = function a(n) {
                  ...
                  this.player.template.playedBarWrap.addEventListener(
                    ...
                    function (t) {
                      if (e.player.video.duration) {
                        var a =
                            e.player.template.playedBarWrap.getBoundingClientRect()
                              .left,
                          n = (t.clientX || t.changedTouches[0].clientX) - a;
                        if (
                          n < 0 ||
                          n > e.player.template.playedBarWrap.offsetWidth
                        )
                          return;
                        var o =
                          e.player.video.duration *
            ...
            },
            {
              ...
              value: function () {
                ...
                this.player.template.volumeBarWrapWrap.addEventListener(
                  ...
                  this.player.template.volumeButtonIcon.addEventListener(
                    "click",
                    function () {
              ...
              value: function () {
                ...
                this.player.options.video.quality &&
                  this.player.template.qualityList.addEventListener(
                    "click",
                    function (t) {
                      t.target.classList.contains("dplayer-quality-item") &&
              ...
              value: function () {
                this.player.options.airplay &&
                  (window.WebKitPlaybackTargetAvailabilityEvent
                    ...
                    : (this.player.template.airplayButton.style.display =
                        "none"));
              },
            },
            {
        ...
        function e(t) {
          ...
          !(function (e, t) {
            ...
            this.player.template.loop.addEventListener("click", function () {
              (a.player.template.loopToggle.checked =
                !a.player.template.loopToggle.checked),
                a.player.template.loopToggle.checked
                  ? (a.loop = !0)
                  : (a.loop = !1),
            ...
            this.player.template.speed.addEventListener("click", function () {
              a.player.template.settingBox.classList.add(
          ...
          for (
            var n = function (e) {
                a.player.template.speedItem[e].addEventListener(
                  "click",
                  function () {
                    a.player.speed(
                      a.player.template.speedItem[e].dataset.speed
                    ),
                      a.hide();
                  }
                );
            ...
            var i = function (e) {
                var t = e || window.event,
                  n =
                    ((t.clientX || t.changedTouches[0].clientX) -
                      r.getBoundingClientRectViewLeft(
                        a.player.template.danmakuOpacityBarWrap
                      )) /
                    130;
                (n = Math.max(n, 0)),
                  (n = Math.min(n, 1)),
              ...
              l = function e() {
                document.removeEventListener(r.nameMap.dragEnd, e),
                  ...
                  a.player.template.danmakuOpacityBox.classList.remove(
              ...
              this.player.template.danmakuOpacityBarWrapWrap.addEventListener(
                ...
                function () {
                  document.addEventListener(r.nameMap.dragMove, i),
                    ...
                    a.player.template.danmakuOpacityBox.classList.add(
                      "dplayer-setting-danmaku-active"
                    );
                }
              );
        ...
        function e(t) {
          ...
          !(function (e, t) {
            ...
            Array.prototype.slice
              .call(this.player.template.menuItem)
          ...
          return (
            ...
            (a = [
              ...
              },
              {
                key: "triggle",
                value: function () {
                  this.container.classList.contains("dplayer-info-panel-hide")
                    ? this.show()
                    : this.hide();
                },
              },
              {
                key: "update",
                value: function () {
                  (this.template.infoVersion.innerHTML = "v"
                    .concat("1.26.0", " ")
                    .concat("63275c8")),
                    ...
                    this.player.options.danmaku &&
                      ...
                      (this.template.infoDanmakuAmount.innerHTML =
                        this.player.danmaku.dan.length));
                },
              },
              {
                key: "fps",
            ...
            !(function (e, t) {
              ...
              (this.options = p(
                (function (e) {
                  ...
                  {
                    preload:
                      "webtorrent" === t.video.type ? "none" : "metadata",
                  },
                  t
                )
              )),
                  ...
                  if (((e = parseFloat(e)), !isNaN(e))) {
                    ...
                    (this.template.volumeBarWrapWrap.dataset.balloon = n),
                      ...
                      a ||
                        this.notice(
                          ""
                            .concat(this.tran("Volume"), " ")
                            .concat((100 * e).toFixed(0), "%")
                        ),
                      (this.video.volume = e),
                          ...
                          if (window.WebTorrent.WEBRTC_SUPPORT) {
                            ...
                            (e.src = ""),
                              ...
                              e.addEventListener(
                                "durationchange",
                                function () {
                                  return a.container.classList.remove(
                                    "dplayer-loading"
                                  );
                                },
                                { once: !0 }
                ...
                value: function (e, t) {
                  ...
                  this.initMSE(e, t),
                    this.on("durationchange", function () {
                      1 !== e.duration &&
                        e.duration !== 1 / 0 &&
                        (a.template.dtime.innerHTML = r.secondToTime(
                          e.duration
                        ));
                    }),
                    ...
                    this.on("error", function () {
                      a.video.error &&
                        ...
                        a.notice &&
                        "webtorrent" !== a.type &&
                        a.notice(a.tran("Video load failed"), -1);
                    }),
                    ...
                    this.on("timeupdate", function () {
                      a.bar.set(
                        "played",
                        a.video.currentTime / a.video.duration,
                        "width"
                      );
                      var e = r.secondToTime(a.video.currentTime);
                      a.template.ptime.innerHTML !== e &&
                        (a.template.ptime.innerHTML = e);
                    });
                  for (
                    var n = function (t) {
                        e.addEventListener(
                          a.events.videoEvents[t],
                          function () {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    this.qualityIndex !== e && !this.switchingQuality)
                  ) {
                    (this.qualityIndex = e),
                    ...
                    var n = Me()({
                      ...
                      o = new DOMParser().parseFromString(n, "text/html").body
                        .firstChild;
                    this.template.videoWrap.insertBefore(
                      ...
                      this.notice(
                        ""
                          .concat(this.tran("Switching to"), " ")
                          .concat(this.quality.name, " ")
                          .concat(this.tran("quality")),
                        -1
                      ),
                      ...
                      this.on("canplay", function () {
                        if (t.prevVideo) {
                          ...
                          t.template.videoWrap.removeChild(t.prevVideo),
                            ...
                            t.notice(
                              ""
                                .concat(t.tran("Switched to"), " ")
                                .concat(t.quality.name, " ")
                                .concat(t.tran("quality"))
                            ),
      ...
      console.log(
        "\n"
          ...
          .concat("63275c8", " %c https://dplayer.js.org ", "\n", "\n"),
